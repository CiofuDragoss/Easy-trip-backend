...
CATEGORY_CONFIG = {
    "Librarii": {
        ...
        "textExcludedTypes": ["supermarket", "hardware_store"],
        "nearbyIncludedTypes": {},
        "textIncludedTypes": [],
        "bannedWordsNearby": [],
        "bannedWordsText": [],
    ...
    "Bijuterii": {
        ...
        "text_query": [],
        "excludedTypes": {"jewelry_store": ["wedding_venue"]},
        "textExcludedTypes": ["wedding_venue", "finance"],
        "nearbyIncludedTypes": {},
        "textIncludedTypes": [],
        "bannedWordsNearby": [],
        "bannedWordsText": [],
    ...
    "Moda si accesorii": {
        ...
        "excludedTypes": {
            ...
            "shoe_store": ["child_care_agency", "tailor", "gift_shop", "wedding_venue"],
        },
        "textExcludedTypes": [],
        "nearbyIncludedTypes": {},
